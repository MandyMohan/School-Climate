...
For Each x In ActiveWorkbook.Sheets("Data").Range("CD2:CD" & last)
   ...
   "C:\Users\" & Environ("username") & "\Documents\School Climate\" & x.Value & " School Climate Parents Report 2022.pdf", Quality:=xlQualityStandard, IncludeDocProperties:=True, IgnorePrintAreas _
